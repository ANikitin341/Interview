/*
    название: слияние интервалов
    
    описание: 
    написать функцию котороя принимает массив с массивами чисел, в массиве два числа
    необходимо вренуть массив смерженных иинтервалов

    теги: [функции, массивы, числа]
